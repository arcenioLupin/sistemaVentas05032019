package com.pe.ventas.back.dtos.rest.ventas;
...
@Data
@NoArgsConstructor
public class VentaRestDto implements Serializable {/**
	 * 
	 */
	private static final long serialVersionUID = -7347860277853163979L;

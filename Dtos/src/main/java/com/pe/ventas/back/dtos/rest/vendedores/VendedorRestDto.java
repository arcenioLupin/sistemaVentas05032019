package com.pe.ventas.back.dtos.rest.vendedores;
...
@Data
@NoArgsConstructor
public class VendedorRestDto implements Serializable {
	
	private static final long serialVersionUID = -5636877297259046471L;
